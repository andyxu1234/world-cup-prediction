...
const TABS = [
  {
    ...
    tagColor: 'green',
    title: '比赛中心',
    desc: '实时查看 2026 世界杯全部 104 场比赛，获取 AI 智能分析解读。',
    features: [
      '数据总览：总场次、活跃 AI 模型数、AI 分析总数',
      '智能筛选：按小组赛、淘汰赛、今日、明日、已结束快速切换',
      '比赛卡片：对阵双方国旗、队名、比分或 VS、比赛时间、轮次',
      'AI 观点摘要：每场比赛展示 AI 综合分析结论',
      '点击进入详情：查看各 AI 模型的独立分析与信心指数',
    ],
  },
  {
    icon: '🏆',
    ...
    tagColor: 'gold',
    title: 'AI 实力排行',
    desc: '多维度排名 10 个 AI 模型的分析准确率。',
    features: [
      'AI 排行：展示各模型的胜负命中率、比分命中率、分析场次',
      '轮次筛选：全部、小组赛、淘汰赛三种统计范围',
      '排序模式：综合、胜负命中率、比分命中率（支持升降序）',
      '模型详情：点击 AI 条目查看专属分析历史与风格标签',
      '赛季/赛事：支持多赛事、多赛季数据切换',
    ],
  },
  {
    ...
    <View className='about-page'>
      <View className='content'>
        ...
        <View className='hero'>
          ...
          <Text className='hero-sub'>AI 驱动的足球分析平台</Text>
        </View>

        {/* 简介 */}
        <View className='card'>
          <Text className='card-title'>AI 足球分析</Text>
          <Text className='card-desc'>
            本小程序汇聚 10 个主流 AI 模型，对 2026 世界杯全部 104 场比赛进行智能分析。你可以查看各 AI 的分析结论、对比准确率，以数据视角读懂比赛。
          </Text>
        </View>
